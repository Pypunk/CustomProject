...
void utils::DrawVector(const Point2f& startPoint, const Vector2f& vector)
{
	Point2f targetPoint{ startPoint.x + vector.x,startPoint.y + vector.y };
	utils::DrawLine(startPoint, targetPoint);
}
